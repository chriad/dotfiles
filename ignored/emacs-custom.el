(custom-set-variables
 ...
 '(magit-repository-directories
   '(("/home/chriad/gh-dotfiles" . 2)
     ("/home/chriad/gh/EMACS" . 1)))
 ...
 '(org-roam-find-file-hook
   '(org-roam-buffer--setup-redisplay-h org-roam--register-completion-functions-h org-roam--replace-roam-links-on-save-h org-roam-db-autosync--setup-update-on-save-h) nil nil "(lambda nil (space-doc-mode))\12(lambda nil\12  (call-interactively #'org-hide-properties))")
...
(custom-set-faces
 ...
 '(org-level-1 ((t (:extend nil :foreground "#4f97d7" :height 1.1))))
