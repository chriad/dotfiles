(
 ...
 ("nebula" . ((user-emacs-directory . "/media/chriad/nebula/spacemacs-bare/")
              (env . (("SPACEMACSDIR" . "/media/chriad/nebula/spacemacs-config-files/nebula")))))
 ...
 ("tmp" . ((user-emacs-directory . "/media/chriad/nebula/spacemacs-tmp/")
            (env . (("SPACEMACSDIR" . "/media/chriad/nebula/spacemacs-config-files/tmp")))))

 ("emacs" . ((user-emacs-directory . "/media/chriad/nebula/spacemacs-emacs/")
             (env . (("SPACEMACSDIR" . "/media/chriad/nebula/spacemacs-config-files/emacs"))))))
