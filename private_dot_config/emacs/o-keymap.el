...
;;   (ripgrep-regexp "/media/chriad/nebula/dotfiles"))


;; (defun search-yt-videos ()
;;   (ignore))


(global-set-key (kbd "C-`") 'spacemacs/shell-pop-ansi-term)
;; (global-set-key (kbd "s-l") 'spacemacs/new-empty-buffer-right)
...
;; (spacemacs/set-leader-keys "ocg" 'search-dotfiles)
;; (spacemacs/set-leader-keys "ocg" 'search-yt-videos)
